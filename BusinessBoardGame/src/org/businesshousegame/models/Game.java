...
public class Game {
	...
	private void loadBoard() {		
		...
		Utilities.displayMessageNewLine("Loaded Game Board.");
	}

	private void loadGameConfigurations()
	{
		gameConfig = Configuration.getInstance();
		gameConfig.readConfigurations();
		if(!gameConfig.validateConfigurations())
		{
			Utilities.displayMessageNewLine("Incorrect configurations!");
			Utilities.displayMessageNewLine("Loading game with below default configurations: ");
	...
	private void loadPlayers() {
		...
		Utilities.displayMessageNewLine("Loaded players.");
	}
	...
	private void updateHotelCellPlayer(Player player, Cell currentCell, StringBuilder spacing) {
		if (currentCell.getOwner() == 0) {
			...
			this.players.get(currentCell.getOwner() - 1).collectAmount(currentCell.getCreditValue());
		} else {
	...
	private void updateTreasureCellPlayer(Player player, Cell currentCell, StringBuilder spacing) {
		player.collectAmount(currentCell.getCreditValue());
